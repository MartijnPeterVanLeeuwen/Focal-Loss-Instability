...
for i in range(steps):
    ...
    if Stable_loss==False:
        loss=torchvision.ops.sigmoid_focal_loss(y_t,labels,alpha=alpha,gamma=gamma,reduction='mean')
    else:
        loss=sigmoid_focal_loss_modified(y_t,labels,alpha=alpha,gamma=gamma,reduction='mean',epsilon=epsilon)
